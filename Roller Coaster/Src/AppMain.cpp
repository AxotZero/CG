	...
	: QMainWindow(parent)
{
	...
	//player->setMedia(QUrl(QUrl::fromLocalFile("../../Media/8.mp3")));
	//	//player->setVolume(50);
	//player->play();
	//QSound *sound = new QSound("../../Media/Heart.wav");
	//	//sound->play();
}
...
//========================================================================
{
	...
	/*trainview->t_time += (dir / m_Track.points.size() / (trainview->DIVIDE_LINE / 1.0));
