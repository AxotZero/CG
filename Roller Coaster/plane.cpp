...
void plane::DimensionTransformation(GLfloat source[], GLfloat target[][4])
{
...
void plane::Paint(GLfloat* ProjectionMatrix, GLfloat* ModelViewMatrix)
{
	GLfloat P[4][4];
	GLfloat MV[4][4];
...
void plane::InitShader(QString vertexShaderPath, QString fragmentShaderPath)
{
	// Create Shader
